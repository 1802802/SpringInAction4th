...
import third.config.EnvironmentConfig;
import third.config.EnvironmentConfigWithDefaults;
import third.config.EnvironmentConfigWithRequiredProperties;
...
public class EnvironmentInjectionTest {
  ...
  @RunWith(SpringJUnit4ClassRunner.class)
  @ContextConfiguration("classpath:/third/placeholder-config.xml")
